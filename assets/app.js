...
(function () {
  ...
  function viewResults() {
    ...
    return `<h1>${T('Your matches', 'Sus coincidencias')}</h1>
      ...
      <div class="btn-row"><a class="btn" href="#/match">${T('Change my answers', 'Cambiar mis respuestas')}</a><button type="button" class="btn" data-print="1">${T('Print or save as PDF', 'Imprimir o guardar como PDF')}</button></div>
